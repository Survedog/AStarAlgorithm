...
std::unique_ptr<AStarWindow> window = std::make_unique<AStarWindow>();
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(window->WindowClassName(), window->WindowTitleName(), WS_OVERLAPPEDWINDOW,
